  ...
  case $::osfamily {
    ...
    default: {
      case $operatingsystem {
        'CentOS': {
          $php_package_name = 'php55w'
          $php_apc_package_name = 'php55w-pecl-apcu'
          $php_memcache_package_name = 'php55w-pecl-memcache'
          $common_package_name = 'php55w-common'
          $cli_package_name = 'php55w-cli'
          $fpm_package_name = 'php55w-fpm'
          $deprecated_php_name = 'php-common.x86_64'
        }
        default: {
          $php_package_name = 'php'
          $php_apc_package_name = 'php-pecl-apc'
          $php_memcache_package_name = 'php-pecl-memcached'
          $common_package_name = 'php-common'
          $cli_package_name = 'php-cli'
          $fpm_package_name = 'php-fpm'
          $deprecated_php_name = 'php55w-common'
        }
      }
